...
public class BasicAuthenticationTest {
    ...
    void test_1(){
       ...
       HttpClientErrorException exception = assertThrows(HttpClientErrorException.class, () -> client.getForObject(greetingUrl(),String.class));
    ...
    void test_4(){
        TestRestTemplate testClient = new TestRestTemplate("user1", "1111");
       ResponseEntity<String> resp = testClient.postForEntity(greetingUrl(), "hoyoung", String.class);
        assertEquals("hello hoyoung",resp.getBody());
    }
